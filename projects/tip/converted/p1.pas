...
Write('│');
GoToXY(41,14);     TextAttr := 015;
Write('·IMAGE·');
GoToXY(48,14);     TextAttr := 012;
Write('│');
GoToXY(49,14);     TextAttr := 015;
Write('▓▓▓▓▓▓');
GoToXY(55,14);     TextAttr := 012;
Write('│');
GoToXY(56,14);     TextAttr := 015;
Write('·PROCESSOR··∙           ');
GoToXY(80,14);     TextAttr := 014;
Write('║');
GoToXY(01,15);     TextAttr := 014;
Write('║');
GoToXY(02,15);     TextAttr := 015;
Write('        ∙······');
GoToXY(17,15);     TextAttr := 013;
Write('└──────┘');
GoToXY(25,15);     TextAttr := 015;
Write('········');
GoToXY(33,15);     TextAttr := 011;
Write('└──────┘');
GoToXY(41,15);     TextAttr := 015;
Write('·······');
GoToXY(48,15);     TextAttr := 012;
Write('└──────┘');
GoToXY(56,15);     TextAttr := 015;
Write('············∙           ');
GoToXY(80,15);     TextAttr := 014;
Write('║');
GoToXY(01,16);     TextAttr := 014;
Write('║');
GoToXY(02,16);     TextAttr := 015;
Write('        ∙·························································∙           ');
GoToXY(80,16);     TextAttr := 014;
Write('║');
GoToXY(01,17);     TextAttr := 014;
Write('║');
GoToXY(02,17);     TextAttr := 015;
Write('        ∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙           ');
GoToXY(80,17);     TextAttr := 014;
Write('║');
GoToXY(01,18);     TextAttr := 014;
Write('║');
GoToXY(02,18);     TextAttr := 015;
Write('                                                                              ');
GoToXY(80,18);     TextAttr := 014;
Write('║');
